        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php echo $this->package_module ?> List
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <?php echo $this->package_module ?> Pages
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo $this->package_module ?> List</div>
                            <div class="actions">
                                <a class="btn danger-btn btn-sm" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/add_package"><i class="fa fa-plus"></i> Add</a>
                            </div>
                        </div>
    ...
    bootbox.confirm("Are you sure you want to "+statusVar+" this?", function(disableConfirm) {    
        if (disableConfirm) {
            jQuery.ajax({
              ...
              dataType : "json",
              url : 'ajaxdisable',
              data : {'tblname':'restaurant_package','entity_id':entity_id,'status':status},
    ...
    bootbox.confirm("Are you sure wants to delete this?", function(disableConfirm) {    
        if (disableConfirm) {
            jQuery.ajax({
              ...
              dataType : "html",
              url : 'ajaxDelete',
              data : {'tblname':'restaurant_package','entity_id':entity_id},
              success: function(response) {
                grid.getDataTable().fnDraw(); 
              },
              error: function(XMLHttpRequest, textStatus, errorThrown) {           
