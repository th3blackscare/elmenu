                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo $this->module_name ?> Page List</div>
                            <div class="actions">
                                <a class="btn default btn-sm" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/add"><i class="fa fa-plus"></i> Add</a>
                            </div>
                        </div>
