...
if($this->input->post()){
  ...
  $FieldsArray = array('entity_id','branch_entity_id','name','phone_number','email','capacity','no_of_table','no_of_hall','hall_capacity','address','landmark','latitude','longitude','state','country','city','zipcode','amount_type','amount','enable_hours','timings','image');
                                ...
                                <div class="form-body"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="name" id="name" placeholder="Enter Branch Name" value="<?php echo $name; ?>" maxlength="100" data-required="1" class="form-control"/>
                                        </div>
                                    </div>   
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="email" name="email" id="email" placeholder="Enter Email" value="<?php echo $email;?>" maxlength="249" data-required="1" class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Address Here.." name="address" id="address" value="<?php echo $address ?>" maxlenght="255"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Landmark<span class="required">*</span></label>
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Landmark Here" name="landmark" id="landmark" value="<?php echo $landmark ?>" maxlenght="255"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Latitude<span class="required">*</span></label>
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Latitude" name="latitude" id="latitude" value="<?php echo $latitude ?>" maxlenght="50"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter Longitude" name="longitude" id="longitude" value="<?php echo $longitude ?>" maxlenght="50"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">ZipCode<span class="required">*</span></label>
                                        <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter ZipCode Here" name="zipcode" id="zipcode" value="<?php echo $zipcode ?>" maxlenght="10"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Country<span class="required">*</span></label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Enter Country" name="country" id="country" value="<?php echo $country; ?>" maxlenght="40"/>
                                        </div>
                                    </div>  
                                    <div class="form-group">
                                        <label class="control-label col-md-3">State<span class="required">*</span></label>
                                        <div class="col-md-4">
                                             <input type="text" class="form-control" placeholder="Enter State" name="state" id="state" value="<?php echo $state ?>" maxlenght="40"/>
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label class="control-label col-md-3">City<span class="required">*</span></label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" placeholder="Enter City" name="city" id="city" value="<?php echo $city ?>" maxlenght="40"/>
                                        </div>
                                    </div>
                                    <div class="form-group">  
                                        ...
                                        <div class="col-md-12">
                                             <table class="timingstable" width="100%" cellpadding="2" cellspacing="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" id="monday_open_hours" name="timings[monday][open]" <?php echo (intval(@$business_timings['monday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['monday']['open']; ?>" placeholder="Select Opening Hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['monday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['monday']['close']; ?>" name="timings[monday][close]" id="monday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours"  <?php echo (intval(@$business_timings['tuesday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['tuesday']['open']; ?>" name="timings[tuesday][open]" id="tuesday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['tuesday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['tuesday']['close']; ?>" name="timings[tuesday][close]" id="tuesday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours" <?php echo (intval(@$business_timings['wednesday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['wednesday']['open']; ?>" name="timings[wednesday][open]" id="wednesday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['wednesday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['wednesday']['close']; ?>" name="timings[wednesday][close]" id="wednesday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours" <?php echo (intval(@$business_timings['thursday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['thursday']['open']; ?>" name="timings[thursday][open]" id="thursday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['thursday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['thursday']['close']; ?>" name="timings[thursday][close]" id="thursday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours" <?php echo (intval(@$business_timings['friday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['friday']['open']; ?>" name="timings[friday][open]" id="friday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['friday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['friday']['close']; ?>" name="timings[friday][close]" id="friday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours" <?php echo (intval(@$business_timings['saturday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['saturday']['open']; ?>" name="timings[saturday][open]" id="saturday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours" <?php echo (intval(@$business_timings['saturday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['saturday']['close']; ?>" name="timings[saturday][close]" id="saturday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:0;">
                                                        <input type="text" class="ophrs" placeholder="Select Opening Hours"  <?php echo (intval(@$business_timings['sunday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['sunday']['open']; ?>" name="timings[sunday][open]" id="sunday_open_hours">
                                                        <input type="text" class="clhrs" placeholder="Select Closing Hours"  <?php echo (intval(@$business_timings['sunday']['off'])) ? '' : 'disabled="disabled"'; ?> value="<?php echo @$business_timings['sunday']['close']; ?>" name="timings[sunday][close]" id="sunday_close_hours">
                                                    </td>
                                                    <td style="border:0;">
