        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h3 class="page-title">
                        <?php  echo 'Delivered ' .$this->module_name ?> List
                    </h3>
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li>
                            <?php echo 'Delivered ' .$this->module_name ?> Pages
                        </li>
                    </ul>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><?php echo 'Delivered ' .$this->module_name ?> List</div>
                            <div class="actions">
                                <a class="btn danger-btn btn-sm" href="<?php echo base_url().ADMIN_URL.'/'.$this->controller_name;?>/add"><i class="fa fa-plus"></i> Add</a>
                                <button class="btn danger-btn btn-sm" id="delete_order"><i class="fa fa-times"></i> Delete</button>
                            </div>
                        </div>
