...
<div class="pdf_main">
    <div class="head-main">
	    <div class="logo"> <img src="https://www.otlobly.me/assets/admin/img/logo.png" alt="" width="240" height="122"/> </div>
	    <div class="head-right" style="float: right;">
	      <div class="quote-title"><img src="https://www.otlobly.me/assets/admin/img/quote-text-img.png" width="135" alt="" /></div>
	      <div class="col-li" style="width: 100px;"> <span class="icon"><img src="https://www.otlobly.me/assets/admin/img/note-icon.png" width="50" alt="" /></span>
	        <p>رقم الطلب. <br>
	          <span><?php echo $order_records->entity_id; ?></span></p>
	      </div>
	      <div class="col-li"> <span class="icon"><img src="https://www.otlobly.me//assets/admin/img/calender.png" width="50"  alt="" /></span>
	        <p>التاريخ <br>
	          <span>
	...
	<div class="segment-main">
        ...
        <div class="div-thead">
          	<div>
	            ...
	            <div style="text-align:left;width:35%;float:left;padding:5px 0 5px 10px;">الصنف</div>
	            <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 0">السعر</div>
	            <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 0">الكمية</div>
	            <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 0">الاجمالي</div>
            </div>
        </div>
        <!-- body -->
        <div>
   ...
   <!--  <div class="segment-main">
    	<div>
    		<div style="text-align:left;width:5%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:35%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:15%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 10px;"><strong>Subtotal</strong></div>
	        <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 10px;">987.5</div>
    	</div>
    	<div>
    		<div style="text-align:left;width:5%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:35%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:15%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 10px;"><strong>Discount</strong></div>
	        <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 10px;">987.5</div>
    	</div>
    	<div>
    		<div style="text-align:left;width:5%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:35%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:15%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 10px;"><strong>Sales Tax</strong></div>
	        <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 10px;">987.5</div>
    	</div>
    	<div>
    		<div style="text-align:left;width:5%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:35%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:left;width:15%;float:left;padding:5px 0 5px 10px;"></div>
	        <div style="text-align:center;width:15%;float:left;padding:5px 0 5px 10px;"><strong>Total</strong></div>
	        <div style="text-align:center;width:20%;float:left;padding:5px 0 5px 10px;">987.5</div>
    	</div>
    </div> -->
