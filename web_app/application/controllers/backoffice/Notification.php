    ...
    public function ajaxview() {
        ...
        foreach ($NotificationData['data'] as $key => $notificationDetails) {
            $records["aaData"][] = array(
                ...
                '<button onclick="deleteNotification('.$notificationDetails->entity_id.')"  title="Click here for Delete" class="delete btn btn-sm danger-btn margin-bottom"><i class="fa fa-times"></i> Delete</button>'
            );
            $nCount++;
        }        
        $records["sEcho"] = $sEcho;
