...
class Users extends CI_Controller {
    ...
    public function add(){
        ...
        if($this->input->post('submit_page') == "Submit")
        {
            ...
            {  
                ...
                $Emaildata = $this->db->get_where('email_template',array('entity_id'=>2))->first_row();
    ...
    public function ajaxview() {
        ...
        $grid_data = $this->users_model->getGridList($sortFieldName,$sortOrder,$displayStart,$displayLength);
