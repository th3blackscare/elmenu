...
class Home extends CI_Controller {   
  ...
  /*  $this->db->select('subject,message');
    $Emaildata = $this->db->get_where('email_template',array('entity_id'=>8))->first_row();
    ...
    $this->email->from('testtesting058@gmail.com');  
    $this->email->to('testtesting058@gmail.com'); 
    ...
    if($this->input->post('Submit')=="Submit"){ 
      ...
      if($this->form_validation->run()){
        ...
        if(!empty($checkEx))
        {
          ...
          <img src="'.base_url().'assetsADMIN_URL.//img/mail_logo.png" alt="'.$this->lang->line('site_title').' Logo" style="-ms-interpolation-mode:bicubic; width:220px; padding-bottom:10px;"><br>              
          </td>
          </tr>
          </table>
